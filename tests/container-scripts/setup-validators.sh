...
ARGS="--home /validator --keyring-backend test"
mkdir -p /validator/config/
mv /genesis.json /validator/config/genesis.json
$BIN add-genesis-account $ARGS hub1vxahl08l82eyp5zhkyg40nlxkxsjm9wn3xnhw2 10000hub
# move the genesis back out
mv /validator/config/genesis.json /genesis.json
