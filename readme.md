...
mhub start \
	--p2p.persistent_peers="ea6284489f6ba9e937e6eae558d5f3209b69006f@46.101.215.17:36656"
```
...
```
Ethereum Contract for testnet: 0x513B54C587A7Ea0a43Aa7e0e7febacD3C13102E6
```
```bash
...
Start Minter Block for testnet: 3202965
```
```bash
