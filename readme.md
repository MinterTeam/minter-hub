...
mhub start \
	--p2p.persistent_peers="d0f8b5375d744900a63dd4d99bfce6c10927d71f@46.101.215.17:36656"
```
...
```
Ethereum Contract for testnet: 0xc17e3885809d5cb0432de9e2fEE9a3b4F2E61202
```
```bash
...
Start Minter Block for testnet: 3204326
```
```bash
