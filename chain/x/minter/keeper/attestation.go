...
func (k Keeper) tryAttestation(ctx sdk.Context, att *types.Attestation, claim types.MinterClaim) {
...
// consensus state.
func (k Keeper) emitObservedEvent(ctx sdk.Context, att *types.Attestation, claim types.MinterClaim) {
...
func (k Keeper) processAttestation(ctx sdk.Context, att *types.Attestation, claim types.MinterClaim) {
	...
	ctx.EventManager().EmitEvent(sdk.NewEvent(
		types.EventTypeProcessAttestation,
		sdk.NewAttribute(sdk.AttributeKeyModule, types.ModuleName),
		sdk.NewAttribute(types.AttributeKeyAttestationID, fmt.Sprint(att.EventNonce)),
	))
