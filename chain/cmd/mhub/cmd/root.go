...
func initRootCmd(rootCmd *cobra.Command, encodingConfig params.EncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		AddPrepGenesisCmd(app.DefaultNodeHome),
...
func createSimappAndExport(
	...
	var peggy *app.Mhub
	if height != -1 {
		peggy = app.NewMhubApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), encCfg, appOpts)

		if err := peggy.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		peggy = app.NewMhubApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), encCfg, appOpts)
	}
