...
pub struct OutgoingTx {
    ...
    #[prost(string, tag="3")]
    pub refund_addr: std::string::String,
    #[prost(int64, tag="4")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgSendToMinterClaim {
    #[prost(uint64, tag="1")]
    pub event_nonce: u64,
    #[prost(string, tag="2")]
    pub token_contract: std::string::String,
    ...
    pub ethereum_sender: std::string::String,
    #[prost(string, tag="5")]
    pub minter_receiver: std::string::String,
    #[prost(string, tag="6")]
    pub orchestrator: std::string::String,
    #[prost(string, tag="7")]
    pub tx_hash: std::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgSendToMinterClaimResponse {
}
...
pub struct MsgWithdrawClaim {
    ...
    pub orchestrator: std::string::String,
    #[prost(string, tag="5")]
    pub tx_sender: std::string::String,
    #[prost(string, tag="6")]
    pub tx_hash: std::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
